    ...
    var that = {
     ...
     console.log(" sys rick")
      ...
      applyBarnesHutRepulsion:function(){
          console.log("sys applyBarnesHutRepulsion")
      ...
      applyCenterDrift:function(){
          console.log("sys applyCenterDrift")
      ...
      applyCenterGravity:function(){
             console.log("sys applyCenterGravity")
      ...
      updateVelocity:function(timestep){
            console.log("sys updateVelocity")
