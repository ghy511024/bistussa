...
<html lang="en">
    <head>
        ...
        <title>北京信息科技大学 SSA 校科协官网</title>
        <meta name="author" content="bistu ghy">
        <link rel="stylesheet" href="css/home.css" type="text/css" charset="utf-8">
    </head>
    <body>
        <div id="arbor">
            <div class="top-head">
                <img id="ssa-logo" src="images/ssa-logo.png"></img>
            </div>
            <div id="nav">
                <a class="back" href="#"></a>
                <p>学习 & 研发 & 分享</p>
    ...
    <script type="text/javascript" src="js/lib/arbor.js"></script>
    <script src="js/lib/arbor-graphics.js"></script>
    <script type="text/javascript" src="js/lib/jquery.address-1.4.min.js"></script>
    <script type="text/javascript" src="js/lib/arbor-tween.js"></script>
